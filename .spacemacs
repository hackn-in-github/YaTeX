...
;;(require 'use-package);;spacemacsではすでに読みこまれているらしい
  (bind-keys :map evil-motion-state-map
             ...
             ("SPC y x k" . my-tex-kijutsu-insert-include)
             ("SPC y x m" . my-tex-mark-setting)
             ("SPC y z d b" . my-tikz-decoration-brace)
             ("SPC y z f e" . my-tikz-foreach-evaluate)
             ("SPC y z f p" . my-tikz-fill-pattern)
             ("SPC y z f r" . my-tikz-foreach-remember)
             ("SPC y z l c" . my-tikz-line-cap)
             ("SPC y z l d a" . my-tikz-line-dash)
             ("SPC y z l d o" . my-tikz-line-double)
             ("SPC y z l j" . my-tikz-line-join)
             ("SPC y z l w" . my-tikz-line-width)
  ...
  (bind-keys :map evil-insert-state-map
             ...
             ("\C-c y z f p" . my-tikz-fill-pattern)
             ("\C-c y z f r" . my-tikz-foreach-remember)
             ("\C-c y z l c" . my-tikz-line-cap)
             ("\C-c y z l d a" . my-tikz-line-dash)
             ("\C-c y z l d o" . my-tikz-line-double)
             ("\C-c y z l j" . my-tikz-line-join)
             ("\C-c y z l w" . my-tikz-line-width)
